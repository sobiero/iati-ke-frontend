  ...
  <div class="mt-3">
    ...
    <div class="row ml-n2 mr-n2 mt-2">
        ...
        <div class="col-md-7">
           ...
           <dashboard-map :dash-params="form" :sel-options="selOptions" :labels="labels" :county-data="dashboard.kpiAndPanel.totalAmtByCounty" class="mt-2"></dashboard-map>
...
export default {
  ...
  computed: {
    ...
    dashboardHeader: function (){
      var tmp = {}, trxTypeTxt ='' , ctyText = '', sdgText = '', yrRangeTxt = '' ;
  ...
  methods: {
    ...
    loadCounty: function() {
      ...
      this.$axios.get( this.apiUrl + `/iati/county`)
        .then(res => {
          ...
          this.$_.forOwn( res.data.data , function(v, k) {
    ...
    loadDateRange: function () {
      ...
      .then(res => {
        ...
        {
           var min = res.data.data[0].trans_date;
           var max = res.data.data[1].trans_date;
